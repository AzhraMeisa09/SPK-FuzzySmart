...
<head>
    ...
    <title>Password Anda Telah Diperbarui - SPK TK Negeri Pembina Padang Panjang</title>
    <style>
        /* Base Reset */
            ...
            <tr>
                <td class="content-body">
                    ...
                    <p class="welcome-desc">
                        Informasi login Anda baru saja diperbarui oleh Administrator di dalam <strong>Sistem Pendukung Keputusan (SPK) Penilaian Perkembangan Siswa</strong> TK Negeri Pembina Padang Panjang. Berikut adalah kredensial terbaru Anda untuk masuk kembali ke sistem.
                    </p>

                    <!-- Credentials Details Card -->
                    <div class="credentials-card">
                        <div class="credentials-header">Informasi Login Terbaru Anda</div>
                        ...
                        <div class="credential-row" style="margin-top: 8px;">
                            <span class="credential-label">Password Baru Anda</span>
                    ...
                    <div class="tips-box">
                        ...
                        <div class="tips-content">
                            ...
                            <p>Jika Anda merasa tidak melakukan perubahan password ini atau tidak meminta bantuan Administrator untuk mereset akun Anda, segera hubungi tim tata usaha atau Administrator sekolah untuk mengamankan kembali akun Anda.</p>
                        </div>
                    </div>

                    <!-- Disclaimer -->
                    <p style="font-size: 11px; color: #94A3B8; margin-top: 35px; font-style: italic; text-align: center;">
                        *Email ini dikirimkan secara otomatis oleh sistem. Jika Anda merasa tidak pernah mendaftar atau tidak memiliki hubungan dengan TK Negeri Pembina Padang Panjang, abaikan email ini dengan aman.
                    </p>
